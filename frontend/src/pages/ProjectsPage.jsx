  ...
  return (
    <div className="min-h-screen px-4 py-4 text-foreground">
      ...
      <div className="px-2 py-1">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-xl bg-blue-600 px-4 py-4 text-sm font-medium text-white transition hover:bg-blue-700"
          >
            <FolderPlus size={20} />
            New Project
          </button>
      ...
      {isFirstLoad ? (
        ...
        <div className={`mt-5 transition-opacity duration-300 ${isRefetching ? "opacity-60" : "opacity-100"}`}>
